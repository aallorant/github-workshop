...
subtitle: "A starter pack with GitHub Desktop"
...
Two outputs. Both public. Both yours.

::: {.columns}
::: {.column width="50%"}
**Profile**

<https://github.com/aallorant>
...
Four audiences. Each gives a reason.
...
- **Journals**. Increasingly ask for public code, or at least pseudo-code, to reproduce your analyses before publication.

. . .

- **Your career**. A public repo with a clean README is a free, durable output. It shows up when people search your name.
...
![](images/aallorant-profile.png){width="70%" fig-align="center"}

::: aside
Source: <https://github.com/aallorant>. This profile was built using exactly the steps in this workshop.
:::

## A polished project README

![](images/hiv-ineq.png){width="70%" fig-align="center"}

::: aside
Source: <https://github.com/aallorant/sae_facility_surveys>. This is the model for hands-on 3.
:::
...
![](images/github-desktop-screenshot.png){width="65%" fig-align="center"}

::: aside
Tour: changed files on the left, diff on the right, commit box at the bottom, push button top-right. Same layout on macOS and Windows; the **File** menu lives in the top OS menu bar on Mac and inside the GitHub Desktop window on Windows.
:::
...
GitHub displays a repository's `README.md` at the top of your profile page when **all four** of these are true:

- the repository name **matches your GitHub username exactly**
- the repository is **public**
- it contains a file named **`README.md`** at the root
- the `README.md` **has content**

Example: GitHub user `aallorant` creates a public repo called `aallorant` with a `README.md`. The README renders at <https://github.com/aallorant>.
:::

## Set up first (5 minutes, only if needed)

If you have not done this in the past, sort it now before the README task:

- A **GitHub account**: [github.com](https://github.com); use your `.ac.uk` email to be eligible for [GitHub Education](https://education.github.com) benefits.
- **GitHub Desktop**: [desktop.github.com](https://desktop.github.com) (the page auto-detects whether you are on macOS or Windows), then sign in with the account you just created.

If both are already done, skip straight to the task on the next slide.

::: aside
The next 15 minutes include this setup time; budget 5 minutes maximum here, then move on. If installation fails, ask a neighbour or me; do not wait silently.
:::
...
1. **File → New repository**. Name it exactly your GitHub username. Tick "initialize with a README". Make it **public**.
2. **Publish** to GitHub.
...
::: aside
You can also create the repo directly on **github.com**: top-right `+` → **New repository**, name it your username, tick **Add a README**, select **Public**, then **Create repository**. Edit the README in place via the pencil icon. If the README does not appear on your profile within a few minutes, give it 10 to 20 more; brand-new profile repos are sometimes slow to be picked up.
:::
...
## Quick share (3 minutes)

Once your profile renders, turn to a neighbour.

- Show each other your profile page.
- Pick one thing in theirs you might steal for yours.

Make a note; you can update your README later.
...
## Where to put your data {.smaller}

The safest pattern: data outside the repo folder.
...
│   └── dhs-mozambique.dta
│
└── hiv-trends-analysis/        ← the repo
    ├── .git/
    ├── code/
    │   └── 1_data_prep.R       reads: ../data/dhs-mozambique.dta
    ├── output/
    ├── README.md
    └── .gitignore              also lists: data/ (safety net)
```

::: aside
`../data/` means the data folder one level up from where this script lives.
:::

- Git cannot see what is not in the repo.
- For non-sensitive derived data you want to share for reproducibility: keep it inside the repo and do not gitignore it.
...
- Office: **2/4077**
- Email: [adrien.allorant@soton.ac.uk](mailto:adrien.allorant@soton.ac.uk)
- Workshop materials: [github.com/aallorant/github-workshop](https://github.com/aallorant/github-workshop)
